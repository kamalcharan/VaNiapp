-- ==========================================================================
-- BATCH 2 FIX: Copy image_url from DB column into payload.image_uri
--
...
-- Only affects batch 2 diagram questions where image_url was already set
...
WHERE source = 'correction-batch-2'
  AND image_url IS NOT NULL
  AND question_type = 'diagram-based';

-- Verify: should return 20 rows with matching URLs
SELECT

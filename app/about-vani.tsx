...
const VANI_SCREENS = [
  ...
  {
    id: 'journey',
    title: 'Your Strength Levels',
    subtitle: 'I adapt to how you grow',
    body: "You start at Just Started. I give you easy questions first - no stress! As your accuracy and coverage improve, I unlock harder challenges.",
    emoji: '\uD83D\uDDFA\uFE0F',
    highlight: {
      type: 'stages',
      stages: [
        { label: 'Just Started', emoji: '\uD83C\uDF31', active: true },
        { label: 'Getting There', emoji: '\uD83C\uDF3F', active: false },
        { label: 'On Track', emoji: '\uD83C\uDF33', active: false },
        { label: 'Strong', emoji: '\uD83C\uDFC6', active: false },
        { label: 'Needs Focus', emoji: '\uD83D\uDCA1', active: false },
      ],
    },
  },
  {

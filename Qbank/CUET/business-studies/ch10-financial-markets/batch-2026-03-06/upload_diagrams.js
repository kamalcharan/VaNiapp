#!/usr/bin/env node
/**
 * Upload Ch10 Financial Markets diagram images to Supabase Storage + update DB.
 *
 * Usage:
 *   node Qbank/CUET/business-studies/ch10-financial-markets/batch-2026-03-06/upload_diagrams.js
 *   node Qbank/CUET/business-studies/ch10-financial-markets/batch-2026-03-06/upload_diagrams.js --dry-run
 *
...
const DIAGRAMS = [
  { questionId: 'cuet-bst-financial-markets-61', file: 'cuet-bst-financial-markets-61.png', storagePath: 'business-studies/financial-markets/cuet-bst-financial-markets-61.png' },
  { questionId: 'cuet-bst-financial-markets-62', file: 'cuet-bst-financial-markets-62.png', storagePath: 'business-studies/financial-markets/cuet-bst-financial-markets-62.png' },
  { questionId: 'cuet-bst-financial-markets-63', file: 'cuet-bst-financial-markets-63.png', storagePath: 'business-studies/financial-markets/cuet-bst-financial-markets-63.png' },
];
...
async function main() {
  ...
  console.log(`\nBST Ch10 Financial Markets Diagram Upload${dryRun ? ' (DRY RUN)' : ''}`);

#!/usr/bin/env node
/**
 * Upload Ch1 Nature & Significance diagram images to Supabase Storage + update DB.
 *
 * Usage:
 *   node Qbank/CUET/business-studies/ch01-nature-significance/batch-2026-03-05/upload_diagrams.js
 *   node Qbank/CUET/business-studies/ch01-nature-significance/batch-2026-03-05/upload_diagrams.js --dry-run
 *
...
// ═══════════════════════════════════════════════════════════════════
// 7 diagrams: question_id → { file, storagePath }
// ═══════════════════════════════════════════════════════════════════
const DIAGRAMS = [
  // Batch 1 (Q18, Q19)
  { questionId: 'cuet-bst-nature-mgmt-18', file: 'cuet-bst-nature-mgmt-18.png', storagePath: 'business-studies/nature-mgmt/cuet-bst-nature-mgmt-18.png' },
  { questionId: 'cuet-bst-nature-mgmt-19', file: 'cuet-bst-nature-mgmt-19.png', storagePath: 'business-studies/nature-mgmt/cuet-bst-nature-mgmt-19.png' },
  // Batch 2 (Q26, Q27, Q39)
  { questionId: 'cuet-bst-nature-mgmt-26', file: 'cuet-bst-nature-mgmt-26.png', storagePath: 'business-studies/nature-mgmt/cuet-bst-nature-mgmt-26.png' },
  { questionId: 'cuet-bst-nature-mgmt-27', file: 'cuet-bst-nature-mgmt-27.png', storagePath: 'business-studies/nature-mgmt/cuet-bst-nature-mgmt-27.png' },
  { questionId: 'cuet-bst-nature-mgmt-39', file: 'cuet-bst-nature-mgmt-39.png', storagePath: 'business-studies/nature-mgmt/cuet-bst-nature-mgmt-39.png' },
  // Batch 3 (Q49, Q58)
  { questionId: 'cuet-bst-nature-mgmt-49', file: 'cuet-bst-nature-mgmt-49.png', storagePath: 'business-studies/nature-mgmt/cuet-bst-nature-mgmt-49.png' },
  { questionId: 'cuet-bst-nature-mgmt-58', file: 'cuet-bst-nature-mgmt-58.png', storagePath: 'business-studies/nature-mgmt/cuet-bst-nature-mgmt-58.png' },
];
...
async function main() {
  ...
  console.log(`\nBST Ch1 Diagram Upload${dryRun ? ' (DRY RUN)' : ''}`);

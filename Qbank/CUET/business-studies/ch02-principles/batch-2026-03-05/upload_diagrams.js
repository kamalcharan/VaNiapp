#!/usr/bin/env node
/**
 * Upload Ch2 Principles of Management diagram images to Supabase Storage + update DB.
 *
 * Usage:
 *   node Qbank/CUET/business-studies/ch02-principles/batch-2026-03-05/upload_diagrams.js
 *   node Qbank/CUET/business-studies/ch02-principles/batch-2026-03-05/upload_diagrams.js --dry-run
 *
...
// ═══════════════════════════════════════════════════════════════════
const DIAGRAMS = [
  { questionId: 'cuet-bst-principles-61', file: 'cuet-bst-principles-61.png', storagePath: 'business-studies/principles/cuet-bst-principles-61.png' },
  { questionId: 'cuet-bst-principles-62', file: 'cuet-bst-principles-62.png', storagePath: 'business-studies/principles/cuet-bst-principles-62.png' },
  { questionId: 'cuet-bst-principles-63', file: 'cuet-bst-principles-63.png', storagePath: 'business-studies/principles/cuet-bst-principles-63.png' },
];
...
async function main() {
  ...
  console.log(`\nBST Ch2 Principles Diagram Upload${dryRun ? ' (DRY RUN)' : ''}`);

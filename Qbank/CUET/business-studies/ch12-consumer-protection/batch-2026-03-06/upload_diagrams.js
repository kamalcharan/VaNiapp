#!/usr/bin/env node
/**
 * Upload Ch12 Consumer Protection diagram images to Supabase Storage + update DB.
 *
 * Usage:
 *   node Qbank/CUET/business-studies/ch12-consumer-protection/batch-2026-03-06/upload_diagrams.js
 *   node Qbank/CUET/business-studies/ch12-consumer-protection/batch-2026-03-06/upload_diagrams.js --dry-run
 *
...
const DIAGRAMS = [
  { questionId: 'cuet-bst-consumer-protection-61', file: 'cuet-bst-consumer-protection-61.png', storagePath: 'business-studies/consumer-protection/cuet-bst-consumer-protection-61.png' },
  { questionId: 'cuet-bst-consumer-protection-62', file: 'cuet-bst-consumer-protection-62.png', storagePath: 'business-studies/consumer-protection/cuet-bst-consumer-protection-62.png' },
  { questionId: 'cuet-bst-consumer-protection-63', file: 'cuet-bst-consumer-protection-63.png', storagePath: 'business-studies/consumer-protection/cuet-bst-consumer-protection-63.png' },
];
...
async function main() {
  ...
  console.log(`\nBST Ch12 Consumer Protection Diagram Upload${dryRun ? ' (DRY RUN)' : ''}`);
  ...
  for (const diag of DIAGRAMS) {
    ...
    const { error: uploadError } = await supabase.storage
      .from(STORAGE_BUCKET)
      .upload(diag.storagePath, fileBuffer, { contentType: 'image/png', upsert: true });
    ...
    const { data: urlData } = supabase.storage.from(STORAGE_BUCKET).getPublicUrl(diag.storagePath);
  ...
  if (errors > 0) { console.log('\nSome operations failed. Re-run to retry.'); process.exit(1); }

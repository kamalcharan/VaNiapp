#!/usr/bin/env node
/**
 * Upload Ch3 Business Environment diagram images to Supabase Storage + update DB.
 *
 * Usage:
 *   node Qbank/CUET/business-studies/ch03-environment/batch-2026-03-05/upload_diagrams.js
 *   node Qbank/CUET/business-studies/ch03-environment/batch-2026-03-05/upload_diagrams.js --dry-run
 *
...
// ═══════════════════════════════════════════════════════════════════
const DIAGRAMS = [
  { questionId: 'cuet-bst-environment-61', file: 'cuet-bst-environment-61.png', storagePath: 'business-studies/environment/cuet-bst-environment-61.png' },
  { questionId: 'cuet-bst-environment-62', file: 'cuet-bst-environment-62.png', storagePath: 'business-studies/environment/cuet-bst-environment-62.png' },
  { questionId: 'cuet-bst-environment-63', file: 'cuet-bst-environment-63.png', storagePath: 'business-studies/environment/cuet-bst-environment-63.png' },
];
...
async function main() {
  ...
  console.log(`\nBST Ch3 Environment Diagram Upload${dryRun ? ' (DRY RUN)' : ''}`);

#!/usr/bin/env node
/**
 * Upload Ch11 Marketing diagram images to Supabase Storage + update DB.
 *
 * Usage:
 *   node Qbank/CUET/business-studies/ch11-marketing/batch-2026-03-06/upload_diagrams.js
 *   node Qbank/CUET/business-studies/ch11-marketing/batch-2026-03-06/upload_diagrams.js --dry-run
 *
...
// ═══════════════════════════════════════════════════════════════════
const DIAGRAMS = [
  { questionId: 'cuet-bst-marketing-61', file: 'cuet-bst-marketing-61.png', storagePath: 'business-studies/marketing/cuet-bst-marketing-61.png' },
  { questionId: 'cuet-bst-marketing-62', file: 'cuet-bst-marketing-62.png', storagePath: 'business-studies/marketing/cuet-bst-marketing-62.png' },
  { questionId: 'cuet-bst-marketing-63', file: 'cuet-bst-marketing-63.png', storagePath: 'business-studies/marketing/cuet-bst-marketing-63.png' },
];
...
async function main() {
  ...
  console.log(`\nBST Ch11 Marketing Diagram Upload${dryRun ? ' (DRY RUN)' : ''}`);

#!/usr/bin/env node
/**
 * Upload Ch4 Planning diagram images to Supabase Storage + update DB.
 *
 * Usage:
 *   node Qbank/CUET/business-studies/ch04-planning/batch-2026-03-05/upload_diagrams.js
 *   node Qbank/CUET/business-studies/ch04-planning/batch-2026-03-05/upload_diagrams.js --dry-run
 *
...
// ═══════════════════════════════════════════════════════════════════
const DIAGRAMS = [
  { questionId: 'cuet-bst-planning-61', file: 'cuet-bst-planning-61.png', storagePath: 'business-studies/planning/cuet-bst-planning-61.png' },
  { questionId: 'cuet-bst-planning-62', file: 'cuet-bst-planning-62.png', storagePath: 'business-studies/planning/cuet-bst-planning-62.png' },
  { questionId: 'cuet-bst-planning-63', file: 'cuet-bst-planning-63.png', storagePath: 'business-studies/planning/cuet-bst-planning-63.png' },
];
...
async function main() {
  ...
  console.log(`\nBST Ch4 Planning Diagram Upload${dryRun ? ' (DRY RUN)' : ''}`);

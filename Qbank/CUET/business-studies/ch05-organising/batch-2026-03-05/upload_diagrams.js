#!/usr/bin/env node
/**
 * Upload Ch5 Organising diagram images to Supabase Storage + update DB.
 *
 * Usage:
 *   node Qbank/CUET/business-studies/ch05-organising/batch-2026-03-05/upload_diagrams.js
 *   node Qbank/CUET/business-studies/ch05-organising/batch-2026-03-05/upload_diagrams.js --dry-run
 *
...
// ═══════════════════════════════════════════════════════════════════
const DIAGRAMS = [
  { questionId: 'cuet-bst-organising-61', file: 'cuet-bst-organising-61.png', storagePath: 'business-studies/organising/cuet-bst-organising-61.png' },
  { questionId: 'cuet-bst-organising-62', file: 'cuet-bst-organising-62.png', storagePath: 'business-studies/organising/cuet-bst-organising-62.png' },
  { questionId: 'cuet-bst-organising-63', file: 'cuet-bst-organising-63.png', storagePath: 'business-studies/organising/cuet-bst-organising-63.png' },
];
...
async function main() {
  ...
  console.log(`\nBST Ch5 Organising Diagram Upload${dryRun ? ' (DRY RUN)' : ''}`);

#!/usr/bin/env node
/**
 * Upload Ch9 Financial Management diagram images to Supabase Storage + update DB.
 *
 * Usage:
 *   node Qbank/CUET/business-studies/ch09-financial-mgmt/batch-2026-03-06/upload_diagrams.js
 *   node Qbank/CUET/business-studies/ch09-financial-mgmt/batch-2026-03-06/upload_diagrams.js --dry-run
 *
...
// ═══════════════════════════════════════════════════════════════════
const DIAGRAMS = [
  { questionId: 'cuet-bst-financial-mgmt-66', file: 'cuet-bst-financial-mgmt-66.png', storagePath: 'business-studies/financial-mgmt/cuet-bst-financial-mgmt-66.png' },
  { questionId: 'cuet-bst-financial-mgmt-67', file: 'cuet-bst-financial-mgmt-67.png', storagePath: 'business-studies/financial-mgmt/cuet-bst-financial-mgmt-67.png' },
  { questionId: 'cuet-bst-financial-mgmt-68', file: 'cuet-bst-financial-mgmt-68.png', storagePath: 'business-studies/financial-mgmt/cuet-bst-financial-mgmt-68.png' },
];
...
async function main() {
  ...
  console.log(`\nBST Ch9 Financial Management Diagram Upload${dryRun ? ' (DRY RUN)' : ''}`);

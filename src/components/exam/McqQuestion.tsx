...
interface Props extends QuestionRendererProps {
  payload: McqPayloadShape;
}

export function McqQuestion({ question, language, selectedOptionId, showFeedback, onSelect, colors, payload }: Props) {
